...
def test_as_symmetric_basic(dtype, shape):
    """Test basic as_symmetric with various shapes and dtypes"""
    ...
    # Import it
    imported = shmem.as_symmetric(external)
...
def test_as_symmetric_shared_memory(dtype):
...
def test_as_symmetric_metadata():
...
def test_import_edge_cases():
    ...
    imp_small = shmem.as_symmetric(ext_small)
    ...
    imp_large = shmem.as_symmetric(ext_large)
