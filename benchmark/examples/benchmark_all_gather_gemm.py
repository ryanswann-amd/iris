...
module_path = "examples.14_all_gather_gemm.all_gather_gemm_pull"
...
def main():
    ...
    for config in configs_to_run:
        ...
        if default_args.benchmark:
            ...
            shmem.log_stats(f"Result (CUDA Events): {avg_kernel_ms:.3f} ms for the kernel")
