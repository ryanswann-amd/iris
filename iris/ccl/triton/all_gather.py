...
def capture_all_gather_descriptor(
    ...
    """Capture a fused-launch descriptor for the all-gather warm path (K-871).

    Thin wrapper over :func:`make_descriptor` that resolves the variant
    (persistent vs partitioned) and lays out the kernel's positional args.
    """
