...
def capture_reduce_scatter_descriptor(
    ...
    """Capture a fused-launch descriptor for the reduce-scatter warm path (K-871).

    Thin wrapper over :func:`make_descriptor`. Distinct from the other two
    captures only in the trailing ``DISTRIBUTION`` constexpr.
    """
