...
def parse_args():
    ...
    parser.add_argument("-k", type=int, default=8192, help="Common dimension between matrices A and B")
    parser.add_argument("--comm_m", type=int, default=32768, help="Number of rows in Comm's matrix")
    parser.add_argument("--comm_n", type=int, default=32768, help="Number of columns in Comm's matrix")
    ...
    parser.add_argument(
        "--gemm_sms", type=int, default=128, help="Number of SMs for workgroup-specialized GEMM algorithm"
    )
...
def main():
    ...
    # Allocate Timestamps
    timestamps = Timestamps(num_tiles=args["num_sms"])

    def run_experiment():
        nonlocal comm_tensor
        nonlocal C
