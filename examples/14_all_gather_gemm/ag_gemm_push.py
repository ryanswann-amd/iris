...
def test_correctness():
    ...
    for b_size in batch_sizes:
        ...
        push_shards_kernel[push_grid](
            ...
            BLOCK_SIZE_M=BLOCK_M_PUSH,
            BLOCK_SIZE_K=BLOCK_K_PUSH,
            cur_rank=rank,
    ...
    for b_size in batch_sizes:
        ...
        def iris_push_gemm():
            ...
            wait_and_compute_gemm_kernel[(num_sms,)](
                ...
                BLOCK_SIZE_M=256,
                BLOCK_SIZE_N=64,
                BLOCK_SIZE_K=block_size_k_wait,
                GROUP_SIZE_M=6,
                NUM_SMS=num_sms,
                NUM_XCDS=num_xcds,
                EVEN_K=(K_local % block_size_k_wait == 0),
                cur_rank=rank,
                world_size=world_size,
            )
        ...
        def rccl_ag_triton_gemm_full():
            ...
            local_gemm_kernel[(num_sms,)](
                ...
                BLOCK_SIZE_M=256,
                BLOCK_SIZE_N=64,
                BLOCK_SIZE_K=block_size_k_local,
                GROUP_SIZE_M=6,
                NUM_SMS=num_sms,
                NUM_XCDS=num_xcds,
                EVEN_K=(K % block_size_k_local == 0),
            )
